...
1. Bundle Folder
2. Subfolder DependencyInjection
  > Extension file z.b (RegionExtension.php)
3. Subfolder Model
  >  > Model file z.b (RegionModel.php)

4. Subfolder Ressources
  > Subfolder config
    >> services.yaml
  > Subfolder contao
    >> config
...
module.exports = {
  bundle_categories: async function () {
    return new Promise(async function (resolve, reject) {
      ...
      await module.exports._7_2_generate_file_model_category(bundlename);
  ...
  _2_1_generate_file_Extension: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/DependencyInjection/RegionExtension.php"
        )
  ...
  _4_1_generate_file_services: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Resources/config/services.yml"
        )
        .pipe(replace("##NAME_BUNDLE##", bundlename))
        .pipe(
  ...
  _5_2_generate_file_config: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Resources/contao/config/config.php"
        )
  ...
  _5_4_generate_file_category_table: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Resources/contao/dca/tl_region_category.php"
        )
        .pipe(replace("##NAME_TABLE##", bundlename.toLowerCase()))
        .pipe(rename(`tl_${bundlename.toLowerCase()}_category.php`))
        .pipe(
          gulp.dest(
            "src/" + bundlename + "Bundle" + "/Resources" + "/contao/dca"
          )
  ...
  _5_5_generate_file_table: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Resources/contao/dca/tl_region.php"
        )
        .pipe(replace("##NAME_TABLE##", bundlename.toLowerCase()))
  ...
  _6_1_generate_file_modules: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Resources/contao/languages/de/modules.php"
        )
        .pipe(replace("##NAME_TABLE##", bundlename.toLowerCase()))
        .pipe(replace("##NAME_BUNDLE##", bundlename))
        .pipe(
  ...
  _6_2_generate_file_category_table: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Resources/contao/languages/de/tl_region_category.php"
        )
        .pipe(replace("##NAME_TABLE##", bundlename.toLowerCase()))
        .pipe(rename(`tl_${bundlename.toLowerCase()}_category.php`))
        .pipe(
  ...
  _6_3_generate_file_table: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Resources/contao/languages/de/tl_region.php"
        )
        .pipe(replace("##NAME_TABLE##", bundlename.toLowerCase()))
        .pipe(rename(`tl_${bundlename.toLowerCase()}.php`))
        .pipe(
  ...
  _7_1_generate_file_model: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Model/RegionModel.php"
        )
        .pipe(replace("##NAME_TABLE##", bundlename.toLowerCase()))
        .pipe(replace("##NAME_BUNDLE##", bundlename))
  ...
  _7_2_generate_file_model_category: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/Model/RegionCategoryModel.php"
        )
        .pipe(replace("##NAME_TABLE##", bundlename.toLowerCase()))
        .pipe(replace("##NAME_BUNDLE##", bundlename))
        .pipe(rename(`${bundlename}CategoryModel.php`))
        .pipe(gulp.dest("src/" + bundlename + "Bundle" + "/Model"));
  ...
  _8_generate_file_bundle: async function (bundlename) {
    return new Promise(async function (resolve, reject) {
      gulp
        .src(
          "contao-toolset/extra/templates-ext/templates/RegionBundle/RegionBundle.php"
        )
        .pipe(replace("##NAME_BUNDLE##", bundlename))
